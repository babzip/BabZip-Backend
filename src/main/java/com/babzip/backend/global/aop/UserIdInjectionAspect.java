package com.babzip.backend.global.aop;

import com.babzip.backend.global.jwt.JwtAuthentication;
...
public class UserIdInjectionAspect {
    @Pointcut("@annotation(com.babzip.backend.global.aop.AssignUserId) && (args(userId, ..) || args(.., userId))")
